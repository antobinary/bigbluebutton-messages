...
#MANUAL means that I am sending a jsobject converted from a previously displayed and (perhaps) manually
#edited in the message-library-tool json and not a one level deep jsobject...
