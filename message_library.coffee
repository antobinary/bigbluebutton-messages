...
module.exports.broadcastResizeAndMovePagePresentationEventToJson = (params, onSuccess, onFailure) ->
  ...
  if errors.length > 0
    ...
    header.timestamp = new Date().toUTCString()# TODO: Generate ISO8601 timestamps (https://github.com/csnover/js-iso8601)
    #console.log "_____" + header.timestamp + "_______"
...
#    return true;
#}
module.exports.whiteboardDrawEvent_toJSObject = (message, onSuccess, onFailure) ->
  try
...
###
-useThisKindOfNamesOnly

-in json->jsObject check whether the correct properties are present
